...
function Home1() {
  ...
  {/* Certification Modal */}
  <div id="certificationModal" className="certification-modal" style={{ display: showCertModal ? 'block' : 'none' }}>
